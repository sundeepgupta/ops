...
# Node
alias ni='node-inspector --no-debug-brk --no-preload'
alias nm='nodemon .'
alias nmd='nodemon --debug .'
...
# Set Upper limit on number of files (for gulp for Influitive)
ulimit -S -n 2048
...
export NVM_DIR="/Users/sundeep/.nvm"
[ -s "$NVM_DIR/nvm.sh" ] && . "$NVM_DIR/nvm.sh"  # This loads nvm

export PATH="/Users/sundeep/mongodb/bin":$PATH
